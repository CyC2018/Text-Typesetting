...
:triangular_ruler: [剑指 Offer 题解](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/剑指%20offer%20题解.md)

目录根据原书第二版进行编排，代码和原书有所不同，尽量比原书更简洁。

:straight_ruler: [Leetcode 题解](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/Leetcode%20题解.md)

对题目做了一个大致分类，并对每种题型的解题思路做了总结。

:black_nib: [算法](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/算法.md)
...
:open_file_folder: [Linux](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/Linux.md)

基本实现原理以及基本操作。:pizza: :hamburger:

## 网络 :cloud:

:art: [计算机网络](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/计算机网络.md)

物理层、链路层、网络层、运输层、应用层。

:cookie: [HTTP](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/HTTP.md)

方法、状态码、Cookie、缓存、连接管理、HTTPs、HTTP 2.0。

:speaker: [Socket](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/Socket.md)

I/O 模型、I/O 多路复用。

## 面向对象 :couple:

:yum: [设计模式](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/设计模式.md)

实现了 Gof 的 23 种设计模式。

:triumph: [面向对象思想](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/面向对象思想.md)
...
:sweat_drops: [分布式](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/分布式.md)

分布式锁、分布式事务、CAP、BASE、Paxos、Raft

:christmas_tree: [集群](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/集群.md)

负载均衡、Session 管理 :gift:

:ghost: [攻击技术](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/攻击技术.md)

XSS、CSRF、SQL 注入、DDoS

:tada: [缓存](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/缓存.md)

缓存特征、缓存位置、缓存问题、数据分布、一致性哈希、LRU、CDN

:balloon: [消息队列](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/消息队列.md)
